...
// @namespace    https://github.com/fellypsantos/cds-autofill-userscript
// @version      2.2
...
console.log('💜 created by Fellyp Santos fellypsantos2011@gmail.com💜');
...
<button class="clear">Limpar</button>
  ...
  handleSearchSelection: (element) => {
    if (RouteChecker.isCI()) {
      ...
      const cnsInput = document.querySelectorAll('input')[FormHelper.Fields.text_fields.cns];
      cnsInput.focus();
      cnsInput.value = id;
      API.findById(id);
